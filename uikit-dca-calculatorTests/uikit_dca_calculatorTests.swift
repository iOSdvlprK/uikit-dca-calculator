...
final class uikit_dca_calculatorTests: XCTestCase {
    ...
    func testResult_givenLosingAssetAndDCAIsUsed_expectNegativeGains() {
        ...
        // Apr: $1500 / 140 = 10.7142 shares
        // May: $1500 / 130 = 11.5384 shares
        // Jun: $1500 / 120 = 12.5 shares
    ...
    private func buildLosingAsset() -> Asset {
        ...
        let meta = buildMeta()
        let timeSeries: [String: OHLC] = [
            "2023-01-25": OHLC(open: "170", close: "160", adjustedClose: "160"),
